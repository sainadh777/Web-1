...
my $query = "select sku,category.name as category,vendor.name as vendor,vendorModel,description,features,cost,retail,quantity,image from product,vendor,category  where sku like '%$keyword%' and vendor.id=product.venID and category.id=product.catID";
